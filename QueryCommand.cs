...
{
    public QueryCommand() : base("query", "create CQRS Query, QueryHandler")
    {
        var nameOption = new Option<string>(new []{"--name", "-n"}, "create CQRS Query, QueryHandler with given name");
        var typeOption = new Option<string>(new []{"--type", "-t"}, "create CQRS Query, QueryHandler with given return type");
        var nsOption = new Option<string>(new []{"--namespace", "-ns"}, "create CQRS Query, QueryHandler with given namespace");
        Add(nameOption);
        Add(typeOption);
        Add(nsOption);
